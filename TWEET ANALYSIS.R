...
searchString1 = '#businessanalytics'   # change this to see others eg analytics...
...
#@IIM_Sirmaur
searchString2 = 'Vineshrockzzz'   # change this to see others
...
rt <- search_tweets( "trump OR president OR potus", n = 50, retryonratelimit = TRUE)
...
#multiple searches
ds <- Map("search_tweets",  c("\"data science\"", "rstats OR python"),  n = 50)
